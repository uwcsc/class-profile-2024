...
export default function Personal() {
  return (
    <PageTemplate name="personal" alt="Personal">
      ...
      <StandardChart variant="blank" title="What is one extracurricular you regret not joining?" noscroll chart={<QuotationCarousel data={P2} height={525} />}>
        <p>
      ...
      <StandardChart
        variant="light"
        vertical
        title="What is the best life hack/tip?"
        noscroll
        chart={<QuotationCarousel data={P3} height={525} />}></StandardChart>
      <StandardChart
        variant="blank"
        vertical
