      ...
      <TooltipContext.Provider value={setTooltip}>
        <div className="w-full flex flex-col items-center gap-8">
          <StandardChart variant="dark" title="What category of electives for your degree did you enjoy the most?" chart={<Pie data={A1} />}>
            <p>
              People were allowed to select multiple categories. 23 people enjoyed Social Sciences, 20 Communications and Humanities courses, 5 Pure Science,
              and only 2 Applied Science. The popularity of these subjects is likely due to vastly different content from that taught in Math and CS courses,
              providing a break from the required courses.
            </p>
          </StandardChart>
          <StandardChart
            variant="blank"
            ...
            <p>
              ...
              <b>{flowCourseTransform("CS 135/145")} Functional Programs</b>, <b>{flowCourseTransform("CS 246/246E")} Object-Oriented Software Development</b>,
              and <b>{flowCourseTransform("CS 343")} Concurrent &amp; Parallel Programming</b>.
            </p>
          </StandardChart>
          <StandardChart
            variant="light"
            ...
            <p>
              A couple of courses seemed to be particularly unpopular, with <b>{flowCourseTransform("CS 245/245E")} Logic &amp; Computation</b> being at the top
              of disliked courses and <b>{flowCourseTransform("CS 350")} Operating Systems</b> and{" "}
              <b>{flowCourseTransform("CS 240")} Data Structures & Data Management</b> close behind. This is likely due to their difficulty and the fact that
              they are required courses. <b>{flowCourseTransform("CS 490")} Information Systems Management</b>, a CS elective, was also fairly unpopular with 7
              people naming it as their least favorite course.
            </p>
          </StandardChart>
          <StandardChart
            variant="blank"
            ...
            <p>
              ...
              student. A couple of courses stand out, with 4 students stating that <b>{flowCourseTransform("CO 487")} Applied Cryptography</b> was their
              favorite and 3 stating <b>{flowCourseTransform("ECON 212")} Introduction to Game Theory</b> as theirs. The <b>{flowCourseTransform("BU")}</b>{" "}
              subject is Laurier's code for business courses.
            </p>
            <ToggleFullCharts />
          </StandardChart>
          <StandardChart
            ...
            <p>
              <b>{flowCourseTransform("STAT 231")} Statistics</b> was the least popular non-CS course by far. This course teaches fundamentals of statistics,
              but the content is quite difficult and it is a required course. As of January 2025, it only has a 40% Liked rating on UWFlow.
            </p>
            <ToggleFullCharts />
          </StandardChart>
          <StandardChart
          ...
          <StandardChart
            ...
            <p>
              7 people found <b>{flowCourseTransform("CLAS 104")} Classical Mythology</b> to be the easiest. Its UWFlow ratings reflect this with a 93% Easy
              rating. Of the CS courses, 4 people found <b>{flowCourseTransform("CS 492")} The Social Implications of Computing</b> to be the easiest.
            </p>
          </StandardChart>
          <StandardChart
            variant="blank"
            ...
            <p>
              ...
              regretted taking it the most. Nobody put it down as both the easiest and most regretted, but it's likely that it being a "bird course" (one you
              take for free high marks and not usefulness) and its relative lack of application and relevance contributed to this regret.
            </p>
          </StandardChart>
          <StandardChart
            variant="dark"
            ...
            <p>
              A significant 12 people found <b>{flowCourseTransform("CS 341")} Algorithms</b> to be the most useful. Although it was considered the most
              difficult by the most people of all CS courses, it seems the effort paid off for most people.{" "}
              <b>{flowCourseTransform("CS 246/246E")} Object-Oriented Software Development</b> was also considered very useful in addition to being many
              people's favorite.
            </p>
          </StandardChart>
          <StandardChart
            ...
            <p>
              <b>{flowCourseTransform("CS 490")} Information Systems Management</b> was stated as the least useful course to 8 people, reflecting its
              unpopularity as well with these graduates. <b>{flowCourseTransform("CS 245/245E")} Logic &amp; Computation</b>, the most unpopular CS course, was
              also seen as not very useful.
            </p>
          </StandardChart>
          ...
          <StandardChart variant="blank" title="What were your reason(s) behind transferring?" chart={<Pie data={A11iii} />}>
            <p>
              Most people transferred for better job prospects or due to lack of interest in their previous major with 4 each. 2 people wanted the flexibility
              in the CS schedule and 1 person wanted to avoid specific courses.
            </p>
          </StandardChart>
          <StandardChart
            variant="light"
          ...
          <StandardChart
            variant="blank"
            title="Which study term did you think was the hardest?"
            chart={<HorizontalBar data={A13} lines={[0, 5, 10, 15]} narrow />}>
            <p>Many people found 2B to be difficult. A lot of the harder required 2nd-year courses show up in this term.</p>
          </StandardChart>
          <StandardChart
            variant="dark"
            title="Which study term did you think was the easiest?"
            chart={<HorizontalBar data={A14} lines={[0, 5, 10, 15]} narrow />}>
            <p>
              Most people found 1A or the 4th year terms to be easiest. 1A tends to have a lot of courses that will be review to people who took CS in high
              school and the later years tend to not have required courses and therefore people can take easier and more enjoyable electives.
            </p>
          </StandardChart>
          <StandardChart
            variant="blank"
          ...
          <StandardChart
            ...
            <p>
              Our graduates obtained very respectable cumulative averages this term! CS is a fairly difficult program, so we're proud of everyone who completes
              this program regardless of their grade.
            </p>
          </StandardChart>
          <StandardChart
            variant="blank"
          ...
          <StandardChart variant="light" title="Which specialization(s) did you complete?" chart={<Pie data={A20} rotation={Math.PI / 8} />}>
            <p>
              If you are particularly passionate about a specific topic, specializations can be a great way to focus your studies and gain depth of experience
              in a specific field.
            </p>
          </StandardChart>
          ...
          <StandardChart variant="dark" title="How many midterms/finals have you failed?" chart={<HorizontalBar data={A22} lines={[0, 10, 20, 30]} narrow />}>
            <p>
              Like previously, most people did not fail any exams, but this number is a lot lower than the number of people who failed no courses. Even if you
              fail a major exam, it doesn't mean that you will fail your course as long as you put in the effort for the rest of the course. No matter if you
              fail one or a few exams, don't give up!
            </p>
          </StandardChart>
          <StandardChart variant="blank" title="Did you take any exchange terms?" chart={<Pie data={A23} />}>
            <p>
              Most people did not take exchange terms. They can be a great opportunity to experience a new environment in a foreign country which can broaden
