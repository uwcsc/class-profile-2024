...
export default function Demographics() {
  return (
    <PageTemplate name="demographics" alt="Demographics">
      ...
      <StandardChart variant="blank" title="What is your gender identity?" chart={<Pie data={D2} />}>
        <p>
          The majority of these graduates identified as men (36), with 10 identifying as women, one as gender non-conforming/non-binary, and one choosing not to
          respond.
        </p>
        <p>
      ...
      <StandardChart variant="light" title="What are your pronouns?" chart={<Pie data={D3} />}>
        <p>
          All male respondents used he/him pronouns and all female respondents used she/her pronouns, with one woman also using they/them pronouns. One person
          used only they/them pronouns.
        </p>
      </StandardChart>
      ...
      <StandardChart variant="blank" title="What is your religion and/or spiritual affiliation?" chart={<Pie data={D6} />}>
        <p>
          Most respondents were not very religious/spiritual with 16 agnostic and 18 atheist. 7 identified as Christian, 5 as Hindu, 3 as Buddhist, 2 as Sikh, 1
          as Daoist, and 1 with mixed feelings about spirituality.
        </p>
      ...
      <StandardChart variant="blank" title="How many languages are you fluent in?" chart={<HorizontalBar data={D8} lines={[0, 10, 20]} />}>
        ...
        <p>
          This remarkable multilingualism enhances our class' global perspectives and strengthens our ability to collaborate on a global scale, reflecting the
          interconnected nature of the tech industry.
        </p>
      </StandardChart>
      <StandardChart
        variant="dark"
        title="Besides English, what languages are you fluent in?"
        chart={<HorizontalBar data={D8i} lines={[0, 5, 10, 15]} narrow />}>
        <p>
      ...
      <StandardChart
        ...
        <p>Most graduates had no close relatives that had attended or were attending UW at the time, but 9 respondents had 1 relative and another 6 had 2.</p>
      </StandardChart>
      ...
      <StandardChart
        ...
        chart={
          <WithBoxPlot points={[90, 95, 96, 97, 99, 95.66]}>
      ...
      <StandardChart variant="light" title="Which of the following specialized high school programs did you do?" chart={<Pie data={D17} />}>
        <p>
          Most students who did specialized programs did AP or IB with a significant portion in gifted/enriched programs. A few students did language immersion
          and other programs.
        </p>
      </StandardChart>
      <StandardChart
        ...
        chart={
          <WithBoxPlot points={[0, 2000, 2500, 7250, 33414, 5585.35]}>
      ...
      <StandardChart
        ...
        chart={
          <HorizontalBar
            ...
            textTransform={(key) => (
              <>
                {key.slice(0, -4)} <code>{key.slice(-4)}</code>
              </>
            )}
          />
        }>
        <p>The MBTI types of the graduating class varied a fair bit, though unsurprisingly, the largest percentage of personalities were Logicians (INTP).</p>
        <p>
